...
p.add_argument('--epoches', type=int, default = 20000)
...
LSTM.build_loss(args.lr, args.decay_rate, num_total_steps/9)
...
with tf.Session() as sess:
   ...
   #For save diagonal data
        saver.restore(sess, args.load_dir + 'model_0_00016-9998')
